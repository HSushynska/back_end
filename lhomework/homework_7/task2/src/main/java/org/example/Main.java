...
Реализуйте таким образом, что бы между менеджером и работником была очередь задач.
 Важно 1) чтобы работники отрабатывали задачи именно по-очереди
   2) возможное количество задач в очереди должно быть ограничено , и если в очереди нет места,
    Manager должен ждать
