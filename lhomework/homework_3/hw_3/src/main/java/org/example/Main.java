...
Теперь, нам необходимо зафиксировать, кто из грузчиков первый справился с поставленной задачей
( и выдать ему премию). Т.е. в main должна появится запись о том, что грузчик такой то первый
...
public class Main {
    ...
    private static final int N_BOX = 1000; // план
    private static final int CAPACITY = 1;// сколько за раз коробок
